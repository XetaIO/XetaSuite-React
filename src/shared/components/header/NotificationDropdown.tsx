...
import { NotificationManager, type Notification } from "@/features/Notifications";
...
export default function NotificationDropdown() {
  ...
  const getNotificationIcon = (notification: Notification) => {
    // You can customize this based on notification.type or notification.icon
              ...
              <li key={notification.id}>
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute right-3 top-3 p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity text-gray-400 hover:text-error-500 hover:bg-error-50 dark:hover:bg-error-900/20"
